...
{
    public partial class OkunacakKitaplar : Form
    {
        public OkunacakKitaplar()
        {
            InitializeComponent();
        ...
        {
            dataGridView1.DataSource = _bookService.GetBooksByStatus(2);
        }
        ...
        private void OkunacakKitaplar_Load(object sender, EventArgs e)
        {
            LoadBook();
            Temizle();
        }
