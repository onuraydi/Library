...
{
    public partial class ALinacakKitaplar : Form
    {
        public ALinacakKitaplar()
        {
            InitializeComponent();
        ...
        {
            dataGridView1.DataSource = _bookService.GetBooksByStatus(3);
        }
        ...
        private void ALinacakKitaplar_Load(object sender, EventArgs e)
        {
            LoadBook();
        }
